    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (theme) {
            case "Orange": rootView = inflater.inflate(R.layout.other_day_fragment_orange, container, false);
                break;
            case "Blue": rootView = inflater.inflate(R.layout.other_day_fragment_blue, container, false);
                break;
            case "Green": rootView = inflater.inflate(R.layout.other_day_fragment_green, container, false);
                break;
